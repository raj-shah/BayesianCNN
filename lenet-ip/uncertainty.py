import os
os.environ["CUDA_VISIBLE_DEVICES"]="-1"   # force to CPU-only
...
if __name__ == '__main__':
    tf.app.flags.DEFINE_string('checkpoint_file_path', 'checkpoints/model.ckpt-990000', 'path to checkpoint file')
