...
class Model(object):
    ...
    def inference(self, images, keep_prob):
        ...
        h_pool1 = self._create_max_pool_2x2(conv1) #do max pooling. output size [batch_size, 14,14,20]
        ...
        h_pool2 = self._create_max_pool_2x2(conv2) #output size [batch_size, 7, 7, 50]
